...
(function(factory) {
    ...
    FileInput.prototype = {
        ...
        _init: function(options, refreshMode) {
            ...
            self.$captionIcon = self.$captionContainer.find(
                ".file-caption-icon"
            );
                ...
                pushAjax: function(index, retry) {
                    ...
                    pool.addTask(pool.size() + 1, function(deferrer) {
                        ...
                        if (
                            ...
                            self._log(
                                "Could not push task to ajax pool for chunk index # " +
                                    index
                            );
                        }
                    });
        ...
        _ajaxSubmit: function(
            ...
            ajaxTask = self.taskManager.addTask(
                fileId + "-" + index,
                function() {
                    var self = this.self,
                        config,
        ...
        setImageOrientation: function($img, $zoomImg, value, $thumb) {
            ...
            $img.off(ev).on(ev, function() {
                ...
                var img = $img.get(0),
                    zoomImg =
                        $zoomImg && $zoomImg.length ? $zoomImg.get(0) : null,
                    h = img.offsetHeight,
                    w = img.offsetWidth,
