                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('educational-admin.teachers.edit', $user->id)}}" class="btn btn-sm btn-primary"><i class="la la-pencil" style="color: white" title="Edit"></i></a>
...
<script>
    $(function () {
        ...
        $(document).on('click', '.btn-show', function () {
            var url = "{{route('educational-admin.teachers.show','id-teacher')}}";
            var _this = $(this);
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        var btn_yes = $('#btn-yes');
        var id_teacher = 0;
        var url = "{{route('educational-admin.teachers.delete','id-teacher')}}"
