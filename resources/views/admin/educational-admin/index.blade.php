        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Tous les Responsables Pédagogiques</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index-2.html">Admin</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Responsables Pédagogiques</a></li>
                                    ...
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$user->country ?? ''}}</td>
                                                <td>
                                                    <a href="#showModal" data-toggle='modal' id-educational-admin={{$user->id}} class="btn btn-sm btn-secondary btn-show"><i class="la la-eye" style="color: white" title="Afficher"></i></a>
                                                    <a href="{{route('admin.educational-admins.edit', $user->id)}}" class="btn btn-sm btn-primary"><i class="la la-pencil" style="color: white" title="Edit"></i></a>
