    ...
    <div class="container-fluid">
        ...
        <div class="mx-0 row page-titles">
            ...
            <div class="mt-2 col-sm-6 p-md-0 justify-content-sm-end mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">ajouter organisation</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.organizations.save') }}" enctype="multipart/form-data" method='post'>
                            @csrf
                            <div class="row">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Logo</label>
                                        <input type="file" id="logo" accept="image/*" name="logo" class="dropify">
                                    </div>
                                </div>
