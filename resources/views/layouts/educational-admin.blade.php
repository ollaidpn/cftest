    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route('educational-admin.dashboard') }}" class="brand-logo">
                {{-- <img class="logo-abbr" src="{{ asset('assets/admin-formateurs/images/logoFC.png')}}" alt=""> --}}
                <img class="logo-compact" src="{{ asset('assets/admin-formateurs/images/logoFC.png')}}" alt="">
                <img class="brand-title" src="{{ asset('assets/admin-formateurs/images/logoFC.png')}}" alt="">
            </a>
        ...
        ***********************************-->
        ...
        <!--**********************************
            Sidebar start
        ***********************************-->
            @include('includes.educational-admin.sidebar')
        <!--**********************************
            Sidebar end
        ***********************************-->
