                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <form wire:submit.prevent={{ $action }}>
                                ...
                                <div class="form-group">
                                    <label for="answer">Ecrire une réponse.</label>
                                    <textarea type="text" class="form-control" rows="4"  wire:model.lazy='answer' id="answer" class="form-control @error('name') is-invalid @enderror" placeholder="Renseigner une quesrtion ici"></textarea>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered verticle-middle table-responsive-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>1</td>
                                        <td style="font-weight:bold">{{$quiz_answers->answer}}</td>
