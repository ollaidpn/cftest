    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-3 col-xxl-3 col-lg-3">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Ajouter/modifier une question</h4>
            ...
            <div class="col-xl-9 col-xxl-9 col-lg-9">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Liste des questions en fonction de chaque modules</h4>
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 d-flex justify-content-end">
                                    <div class="form-group">
                                        <select class="w-auto custom-select" wire:model.lazy='perPage' id="per_page">
                                            @for ($i = 5; $i <= 25; $i +=5)
                            ...
                            <table class="table table-bordered verticle-middle table-responsive-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ ++$key }}</td>
                                        <td style="font-weight:bold">{{$quiz_question->question}}</td>
                                        <td>{{$quiz_question->quiz->module->formation->title}}</td>
                                        <td>{{$quiz_question->quiz->module->title}}</td>
                                        <td>
                                            <span>
                                                <a href="javascript:void()" wire:click='edit({{$quiz_question->id}})' class="mr-4" data-toggle="tooltip"
                                                    data-placement="top" title="Edit"><i
                                                        class="fa fa-pencil color-muted"></i> </a>
                                                <a href="#deleteConfirmationModal" id-quiz={{$quiz_question->id}}
                                                    data-toggle="modal" title="Delete" class="delete-btn"><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Voulez vous vraiment supprimer cette quizz ?
                </div>
